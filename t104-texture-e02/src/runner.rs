...
pub async fn run(event_loop: EventLoop<()>, window: Window) {
    ...
    let texture_sampler_container = gen_sampler(
        &device,
    ...
    let texture_sampler_huaji = gen_sampler(
        &device,
    ...
    let texture_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
        ...
        entries: &[
            wgpu::BindGroupEntry {
                binding: 0,
                resource: wgpu::BindingResource::Sampler(&texture_sampler_container),
            },
            wgpu::BindGroupEntry {
                binding: 1,
            ...
            wgpu::BindGroupEntry {
                binding: 2,
                resource: wgpu::BindingResource::Sampler(&texture_sampler_huaji),
            },
            wgpu::BindGroupEntry {
                binding: 3,
