...
use crate::{texture::gen_texture, vertex::Vertex};
...
pub async fn run(event_loop: EventLoop<()>, window: Window) {
    ...
    let (texture_view_container, texture_sampler_container) =
        gen_texture("assets/texture/container.jpg", &device, &queue);
    let (texture_view_huaji, texture_sampler_huaji) =
        gen_texture("assets/texture/huaji.jpg", &device, &queue);
